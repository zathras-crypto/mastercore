    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Omni Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  mastercored [options]                     " + _("Start Omni Core Daemon") + "\n" +
                _("Usage (deprecated, use mastercore-cli):") + "\n" +
                  "  mastercored [options] <command> [params]  " + _("Send command to Omni Core") + "\n" +
                  "  mastercored [options] help                " + _("List commands") + "\n" +
                  "  mastercored [options] help <command>      " + _("Get help for a command") + "\n";
