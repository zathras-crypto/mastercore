...
callnode1() {
  ./bitcoin-cli -rpcport=8330 -rpcuser=user -rpcpassword=password "$@"
   ...
   callnode1 sendrawtx_MP $ADDR1 "$DEFACCT" "00000032010002000000007465737420737472696e672031007465737420737472696e672032007465737420737472696e672033007465737420737472696e672034007465737420737472696e67203500000000174876E800"
