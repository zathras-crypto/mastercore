...
BOOST_AUTO_TEST_CASE(txbuilder_add_change)
{
    ...
    CBitcoinAddress addrA("LRHQxCu5LAxNvpBg4GYNMFZ9L4fMBVjhN9");
    CBitcoinAddress addrB("LLuvFmdykm8a8Ko54Gs9thgEfcRtGZEiRh");
...
BOOST_AUTO_TEST_CASE(txbuilder_add_change_position)
{
    ...
    CBitcoinAddress addr("LXXCzSnyYmhkE2Fed9suUHMyuS1hf4q5F7");
...
BOOST_AUTO_TEST_CASE(omnitxbuilder_op_return)
{
    ...
    std::string rawTx("01000000021dc7f242305900960a80cadd2a5d06d2cbbc4bbdd029db37c56a975487b8d4b20100000000"
        ...
        "0000000000086a066f6c000001196449f605000000001976a914c359d7d2e140127dd2adbeb1b3e9fa644e7dbd8e88acaa"
        "0a0000000000001976a9141243d1aba8f18d9bae91dac065549f95c403d7cc88ac00000000");
    ...
    std::vector<unsigned char> payload = ParseHex("00000119");
    ...
    tx = OmniTxBuilder(tx)
        .addOpReturn(payload)
        .addReference("LLtXfpC7wsMHT4dopqgb5Scive7FFz855p", 2730LL)
        .addChange("Ld2sf2RMFnhnrtvBqdP1xybeszDXT4ocqS", viewTemp, 10000LL, 1)
        .build();
